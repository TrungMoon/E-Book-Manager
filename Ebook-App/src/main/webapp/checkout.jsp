					...
					<div class="card-body">
						...
						<input type="hidden" value="${userobj.id }" name="id">
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<label for="inputEmail4">Email</label> <input type="email" name="email"
										class="form-control" id="inputEmail4" value="${userobj.email }">
								</div>
							</div>
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputEmail4">Phone Number</label> <input
										type="number" name="phno" class="form-control" id="inputEmail4" value="${userobj.phno }"> 
								</div>
								<div class="form-group col-md-6">
							...
							<div class="text-center">
								...
								<a href="index.jsp" class="btn btn-success">Continua
									Shopping</a>
							</div>
